...
- Designed and implemented the backend for high-throughput and availability using multi-threaded Java.
...
##### **Tasks**: 
- Implemented smaller modules of the system using Java and an in-house Java backend framework and JSP. 
